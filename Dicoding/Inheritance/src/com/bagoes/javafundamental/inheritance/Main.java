package com.bagoes.javafundamental.inheritance;
...
public class Main {
    public static void main(String[] args) {
        ...
        Object object = k; // bisa langsung assign
        Hewan hewanK = k; // bisa langsung assign

        //object.makan(); -> error, karena method makan() tidak ada di class Object
        hewanK.makan();

        Kucing kucingK = (Kucing) h; // tidak bisa langsung assign, perlu casting
        kucingK.makan();
